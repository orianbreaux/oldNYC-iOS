...
func defaultGalleryConfiguration() -> GalleryConfiguration {
    ...
    button.setImage(UIImage(named: "close_normal"), for: UIControl.State())
    button.setImage(UIImage(named: "close_highlighted"), for: UIControl.State.highlighted)
    ...
    detail.setImage(UIImage(named: "MoreDetails"), for: UIControl.State())
    ...
    share.setImage(UIImage(named: "share"), for: UIControl.State())
